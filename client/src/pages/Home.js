...
const BUTTON_DEFINITIONS = [
  ...
  { key: "health", icon: "❤️", color: "green", path: "/health-services" },
  { key: "accessibility", icon: "♿", color: "cyan", path: "/accessibility-services" },
  { key: "transport", icon: "🚗", color: "lime", path: "/transport-services" },
  { key: "employment", icon: "💼", color: "purple", path: "/employment-services" },
